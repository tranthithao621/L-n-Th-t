...
<body>
			...
			<form action="KhachHangServlet" method="POST">
				<table width="450" align="center" cellpadding="5">
					...
					<%
						...
						String tenkh = (String) request.getAttribute("loiten");
					...
					<tr>
						<td><span style="color: red"><span
								style="font-size: 13px">Tên khách hàng không chính xác</span></span></td>
					</tr>
					<%
						}
					%>
 ...
 %></td>
					...
					<tr>
						<td><span style="color: red"><span
								style="font-size: 13px">Số điện thoại phải từ 10 đến 11
									chữ số!</span></span></td>
					</tr>
					<%
						}
					...
					<tr>
						...
						<td width="300"><input type="number" name='txtsodtkhsua'
					...
					<tr>
						...
						<td><input type="submit" value=" Sửa "
							class="btn btn-primary" name='btnsuakh'>&nbsp; <input
							type="submit" value=" Hủy " class="btn btn-danger"></td>
					</tr>
				</table>
			</form>
		</div>
